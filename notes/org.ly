...
CumInvocaremBassFigures = \figuremode {
  ...
  <4 2>2 <5 3> <6+>1 %30
  \bo <[_+]>\breve
  <3>1.. \bassFigureExtendersOn \bc <[3]>4 \bassFigureExtendersOff
  <5>1 <6>
  <7 _+>2 <6 4> \bo <[5 \t]> \bc <[\t _+]>
  r\breve %35
  r
...
QuiHabitatBassFigures = \figuremode {
  ...
  <7>
  r1 <9 4>2 <8 3>
  <[5] _+>2 \bo <[6 4]>1 \bc <[5 _+]>2 %115
  r\breve
  <5>1 <6>
  r2 \bo <[3]> <6> <\t>
  <3>1 \bassFigureExtendersOn <3>2 \bassFigureExtendersOff \bc <[3]>
  r1 <2>2 <5-> %120
  <[4-]> <3> <5 2> <6>
  r <6!>1 <6>2
  <6\\>1 <[7]>2 <6\\>
